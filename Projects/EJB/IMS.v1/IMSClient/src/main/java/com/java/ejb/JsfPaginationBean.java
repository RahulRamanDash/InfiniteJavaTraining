...
public class JsfPaginationBean {
	...
	public List<InsuranceDetails> getInsuranceList() throws NamingException {
		if (cdList == null) {
			loadInsurance();
		}
		return cdList;
	...
	private void loadInsurance() throws NamingException {
		System.out.println("First Row  " +firstRow);
		System.out.println("Count  " +rowsPerPage);
		cdList = queryHelper.getListOfInsurance(firstRow, currentPage);
		System.out.println("Employ Count is  " +cdList);
		totalRows = queryHelper.countRowsEjb();
	...
	// Paging actions
	// -----------------------------------------------------------------------------
	public void pageFirst() throws NamingException {
		page(0);
	}
	public void pageNext() throws NamingException {
		page(firstRow + rowsPerPage);
	}
	public void pagePrevious() throws NamingException {
		page(firstRow - rowsPerPage);
	}
	public void pageLast() throws NamingException {
		page(totalRows - ((totalRows % rowsPerPage != 0) ? totalRows % rowsPerPage : rowsPerPage));
	}
	public void page(ActionEvent event) throws NamingException {
		page(((Integer) ((UICommand) event.getComponent()).getValue() - 1) * rowsPerPage);
	}
	private void page(int firstRow) throws NamingException {
		this.firstRow = firstRow;
		loadInsurance();
	}
}
