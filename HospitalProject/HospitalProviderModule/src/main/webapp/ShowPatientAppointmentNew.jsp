...
<body>
	<h:form id="form">
		...
		<h:commandButton value="Search" styleClass="show-search" onclick="hidesearch();"/>
		<div class="centered-container" id="searchcontainer">
			<fieldset>
    ...
    top: 3px;">
		...
		<script type="text/javascript">
			...
			function hidesearch(){
				var searchcontainer = document.getElementById('form:searchcontainer');
