...
//	static boolean orderBylastName;
	...
	static String orderByappointmentId = "asc";
	...
	public String sortByAppointmentId() {
		...
		sessionMap.put("AppointmentIdOrder", orderByappointmentId);
		sessionMap.put("PatientId", orderBypatientId);
		sessionMap.put("FirstName", orderByfirstName);
		sessionMap.put("LastName", orderBylastName);
		sessionMap.put("AppointmentDate", orderByappointmentDate);
		sessionMap.put("AppointmentTime", orderByappointmentTime);
	...
	public String confirmAppointment(String appointmentId) throws ParseException {
		...
		context.addMessage("manageMsg", new FacesMessage("Appointment Confirmed..."));
	...
	public String cancelAppointment(String appointmentId) throws ParseException {
		...
		context.addMessage("manageMsg", new FacesMessage("Appointment Canceled..."));
