...
<html>
    ...
    <body>
        ...
        <h:dataTable value="#{ejbImpl.searchEmploy()}" var="e" border="3">
              	    <h:column>
                    <f:facet name="header">
                    ...
                    <h:outputText value="#{e.gender}"/>
                                    ...
                                    <h:column>
                     <f:facet name="header">
                    	<h:outputLabel value="Employ Department" />
                    </f:facet>
                    <h:outputText value="#{e.dept}"/>
                </h:column>
                                    <h:column>
                     <f:facet name="header">
                    	<h:outputLabel value="Employ Designation" />
                    </f:facet>
                    <h:outputText value="#{e.desig}"/>
                </h:column>
                                    <h:column>
                     <f:facet name="header">
                    	<h:outputLabel value="Employ Salary" />
                    </f:facet>
                ...
                <h:column>
                    ...
                    <h:commandButton action="#{ejbImpl.searchEmploy(e.empno)}" 
                    	value="Search" />
                </h:column>
                <h:column>
                     <f:facet name="header">
