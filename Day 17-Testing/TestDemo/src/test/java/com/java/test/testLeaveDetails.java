...
public class testLeaveDetails {
	...
	public void testConstructor() throws ParseException {
		...
		assertEquals(cdate, leavedetails1.getAppliedOn());
	}
	...
	public void testGettersAndSetters() throws ParseException {
		...
		leavedetails.setAppliedOn(cdate);
		...
		assertEquals(cdate, leavedetails.getAppliedOn());
	}
	@Test
	public void testToString() throws ParseException {
		...
		Date led = sdf.parse("2023-10-10");
		Date cdate = new Date();
		LeaveDetails leavedetails = new LeaveDetails(1,1000,"Rahul",lsd,led,LeaveStatus.PENDING,LeaveType.EL,"sadi","welcome",cdate);	
		String result = "LeaveDetails [leaveId=1, empId=1000, empName=Rahul, leaveStartDate=Tue Oct 10 00:00:00 IST 2023, leaveEndDate=Tue Oct 10 00:00:00 IST 2023, leaveStatus=PENDING, leaveType=EL, leaveReason=sadi, managerComments=welcome, appliedOn="+cdate+"]";
